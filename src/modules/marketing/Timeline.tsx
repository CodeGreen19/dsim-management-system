...
export const Timeline = ({ data }: { data: TimelineEntry[] }) => {
  ...
  const { data: isAuth, isPending } = useUserAuth();
    ...
    >
      ...
      >
        <Image
          ...
          width={120}
          alt="logo"
          className=" p-1 mb-2 size-[80px] md:size-[120px] rounded-full bg-white rounded-b-none"
        />
        <h2 className="text-lg md:text-4xl mb-4 text-black dark:text-white max-w-4xl">
          দারুস সুন্নাহ ইসলামিয়া মাদ্রাসা
        </h2>
        <p className="text-neutral-700 dark:text-neutral-300 text-sm md:text-base max-w-sm">
          Darussunnah Islamica Madrasha offers Islamic education, teaching the
          Quran and Islamic law. It may also include other subjects, providing a
